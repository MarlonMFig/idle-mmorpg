...
const SKILL_LIST: SkillDefinition[] = [
  ...
  },
  {
    ...
    damage: 40,
    icon: '/sprites/skills/yang.svg',
    animation: { kind: 'character', durationMs: 417, scale: 1 },
    range: 96,
    description:
      'Punho Gentil — golpes nos tenketsu. (WONSR Hyūga: Juuken, pasta hinata/50.lua)',
  },
  {
    id: 'skill-juuken-kushou',
    name: 'Jūken Kūshō',
    element: 'yang',
    requiredLevel: 5,
    cooldownMs: 7000,
    ...
    contactRange: 40,
    description:
      'Palma de ar do Punho Gentil. (WONSR Hyūga: Juuken Kushou, hinata/170.lua)',
  },
  {
    ...
    areaRadius: 56,
    description:
      'Palma Rotatória do Céu — cúpula de chakra dos Oito Trigramas. (WONSR: Hakkeshou Kaiten, hinata/100.lua)',
  },
  {
    id: 'skill-juhou-soshiken',
    name: 'Jūhō Sōshiken',
    element: 'yang',
    requiredLevel: 30,
    cooldownMs: 12000,
    damage: 120,
    icon: '/sprites/skills/yang.svg',
    animation: { kind: 'character', durationMs: 750, scale: 1 },
    range: 96,
    dashToTarget: true,
    contactRange: 36,
    description:
      'Golpe que sela pontos de chakra. (WONSR Hyūga: Juhou Soshiken, hinata/200.lua)',
  },
  {
    id: 'skill-rasengan',
    name: 'Rasengan',
    ...
    damage: 40,
    icon: '/sprites/skills/yang.svg',
    animation: { kind: 'character', durationMs: 1333, scale: 1 },
    range: 72,
    // Pack hitDelay 750 (f9) — investida a partir da carga (~f3).
    dashToTarget: true,
    contactRange: 36,
    dashStartMs: 250,
    developmentStatus: 'ready',
    description: 'Esfera de chakra giratória. Investida até o alvo. (NTO: Rasengan)',
    ai: {
      autoUse: true,
      priority: 1,
      energyCost: 22,
  ...
  },
  {
    ...
    range: 110,
    developmentStatus: 'ready',
    description: 'Arremessa kunai com selo explosivo no alvo — Jutsu do Shikamaru (Bakushiki Shojin).',
  },
  {
  ...
  },
  {
    ...
    range: 100,
    // Pack: Baika seals→expand→spin; dash quando a bola forma (~1167ms).
    dashToTarget: true,
    contactRange: 40,
    dashStartMs: 1167,
    developmentStatus: 'ready',
  ...
  },
  {
    ...
    range: 88,
    developmentStatus: 'ready',
    description: 'Palma expandida — Jutsu 2 do Chouji (Hands Demoler / mãos gigantes).',
    ai: {
      autoUse: true,
      priority: 2,
      energyCost: 24,
  ...
  },
  {
    ...
    areaRadius: 52,
    developmentStatus: 'ready',
    description: 'Expansão + impacto no chão — Jutsu 3 do Chouji (Earthquake).',
    ai: {
      autoUse: true,
      priority: 3,
      energyCost: 26,
  ...
  },
  {
    ...
    range: 72,
    developmentStatus: 'ready',
    description: 'Expansão parcial — Jutsu 4 do Chouji (selo → bola inflada).',
    ai: {
      autoUse: true,
      priority: 4,
      energyCost: 22,
