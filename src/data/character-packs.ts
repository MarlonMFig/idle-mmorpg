...
const SHIKAMARU_JUTSU_ANIMS: Record<string, CharacterSkillAnimDef> = {
  ...
  'shikamaru-jutsu-3': {
    ...
    hitDelayMs: 280,
    vfxId: 'jutsu-3',
    // 5.55 era calibrado com cast.scale 0.35 herdado no VFX; agora a pose não entra na conta.
    fxScale: 1.94,
    vfxOffsetX: 0,
    vfxOffsetY: 0,
    vfxLoopMode: 'none',
...
const HINATA_JUTSU_ANIMS: Record<string, CharacterSkillAnimDef> = {
  ...
  'hinata-palm': {
    key: 'hinata-frame-001',
    url: '/sprites/player/hinata/poses/frame-001/frame-001.png',
    frames: [
      '/sprites/player/hinata/poses/frame-001/frame-001.png',
      '/sprites/player/hinata/poses/frame-001/frame-002.png',
      '/sprites/player/hinata/poses/frame-001/frame-003.png',
      '/sprites/player/hinata/poses/frame-001/frame-004.png',
      '/sprites/player/hinata/poses/frame-001/frame-005.png',
      '/sprites/player/hinata/poses/frame-001/frame-006.png',
      '/sprites/player/hinata/poses/frame-001/frame-007.png',
    ],
    frameWidth: 80,
    frameHeight: 66,
    frameCount: 7,
