...
export function pickEvenSpawns(
...
function narutoTopdownHunt(
  ...
  spawn: { x: number; y: number },
  enemySpawns: readonly { x: number; y: number }[],
  meta?: { width?: number; height?: number; cacheTag?: string },
): WonsrRenderedMap {
  const width = meta?.width ?? 3840;
  const height = meta?.height ?? 2160;
  const cacheTag = meta?.cacheTag ?? 'tdnov2026';
  return {
    mapKey,
    imageKey: slug,
    imageUrl: `/maps/${slug}.png?v=${cacheTag}`,
    width,
    height,
    spawn,
...
export const WONSR_RENDERED_MAPS: Partial<Record<MapKey, WonsrRenderedMap>> = {
  ...
  [MAP_KEYS.huntValeDoFim]: {
    ...
    imageUrl: '/maps/hunt-vale-do-fim.png?v=hq2026',
    foregroundKey: 'map-hunt-vale-do-fim-fg',
    foregroundUrl: '/maps/hunt-vale-do-fim-fg.png?v=hq2026',
    width: 6688,
    height: 3764,
    spawn: { x: 3344, y: 2412 },
    enemySpawns: [
  ...
  [MAP_KEYS.huntCampoTreinamento]: {
    ...
    imageUrl: '/maps/hunt-campo-treinamento.png?v=hq2026',
    foregroundKey: 'map-hunt-campo-treinamento-fg',
    foregroundUrl: '/maps/hunt-campo-treinamento-fg.png?v=hq2026',
    width: 6688,
    height: 3764,
    spawn: { x: 3344, y: 2415 },
    enemySpawns: [
  ...
  [MAP_KEYS.huntPontePaisOnda]: {
    ...
    imageUrl: '/maps/hunt-ponte-pais-onda.png?v=hq2026',
    foregroundKey: 'map-hunt-ponte-pais-onda-fg',
    foregroundUrl: '/maps/hunt-ponte-pais-onda-fg.png?v=hq2026',
    width: 6688,
    height: 3764,
    spawn: { x: 3344, y: 2562 },
    enemySpawns: [
  ...
  [MAP_KEYS.huntEsconderijoAkatsuki]: {
    ...
    imageUrl: '/maps/hunt-esconderijo-akatsuki.png?v=hq2026',
    foregroundKey: 'map-hunt-esconderijo-akatsuki-fg',
    foregroundUrl: '/maps/hunt-esconderijo-akatsuki-fg.png?v=hq2026',
    width: 8192,
    height: 4608,
    spawn: { x: 4096, y: 2987 },
    enemySpawns: [
  ...
  [MAP_KEYS.huntLabOrochimaru]: {
    ...
    imageUrl: '/maps/hunt-lab-orochimaru.png?v=hq2026',
    foregroundKey: 'map-hunt-lab-orochimaru-fg',
    foregroundUrl: '/maps/hunt-lab-orochimaru-fg.png?v=hq2026',
    width: 8192,
    height: 4608,
    spawn: { x: 4096, y: 2987 },
    enemySpawns: [
  ...
  [MAP_KEYS.huntPaisDoVento]: {
    ...
    imageUrl: '/maps/hunt-pais-do-vento.png?v=hq2026',
    foregroundKey: 'map-hunt-pais-do-vento-fg',
    foregroundUrl: '/maps/hunt-pais-do-vento-fg.png?v=hq2026',
    width: 8192,
    height: 4608,
    spawn: { x: 4096, y: 2959 },
    enemySpawns: [
  ...
  [MAP_KEYS.huntArenaExameChunnin]: {
    ...
    imageUrl: '/maps/hunt-arena-exame-chunnin.png?v=hq2026',
    foregroundKey: 'map-hunt-arena-exame-chunnin-fg',
    foregroundUrl: '/maps/hunt-arena-exame-chunnin-fg.png?v=hq2026',
    width: 8192,
    height: 4608,
    spawn: { x: 4096, y: 2987 },
    enemySpawns: [
  ...
  [MAP_KEYS.huntArenaExameChunin]: {
    ...
    imageUrl: '/maps/hunt-arena-exame-chunin.png?v=hq2026',
    foregroundKey: 'map-hunt-arena-exame-chunin-fg',
    foregroundUrl: '/maps/hunt-arena-exame-chunin-fg.png?v=hq2026',
    width: 6688,
    height: 3764,
    spawn: { x: 3344, y: 2614 },
    enemySpawns: [
  ...
  [MAP_KEYS.huntDistritoUchiha]: {
    ...
    imageUrl: '/maps/hunt-distrito-uchiha.png?v=hq2026',
    foregroundKey: 'map-hunt-distrito-uchiha-fg',
    foregroundUrl: '/maps/hunt-distrito-uchiha-fg.png?v=hq2026',
    width: 8000,
    height: 4500,
    spawn: { x: 4000, y: 2958 },
    enemySpawns: [
  ...
  [MAP_KEYS.huntKonohaDestruida]: {
    mapKey: MAP_KEYS.huntKonohaDestruida,
    imageKey: 'map-hunt-konoha-destruida',
    imageUrl: '/maps/hunt-konoha-destruida.png?v=hq2026',
    width: 8192,
    height: 4608,
    spawn: { x: 4224, y: 3104 },
    enemySpawns: [
  ...
  // Aba WONSR: 8 mapas top-down Naruto 3840×2160.
    ...
    { width: 4096, height: 2304, cacheTag: 'tdnov2026' },
  ),
    ...
    { width: 3344, height: 1882, cacheTag: 'tdnov2026' },
  ),
    ...
    [MAP_KEYS.huntTdIlhaTartaruga]: narutoTopdownHunt(
    MAP_KEYS.huntTdIlhaTartaruga,
    'hunt-td-ilha-tartaruga',
    { x: 2040, y: 1144 },
    [
      { x: 1160, y: 872 },
      { x: 2808, y: 904 },
    ...
    [MAP_KEYS.huntTdMonteMyoboku]: narutoTopdownHunt(
    MAP_KEYS.huntTdMonteMyoboku,
    'hunt-td-monte-myoboku',
    { x: 2040, y: 1144 },
    [
      { x: 1752, y: 520 },
      { x: 1928, y: 808 },
    ...
    [MAP_KEYS.huntTdUzushiogakure]: narutoTopdownHunt(
    MAP_KEYS.huntTdUzushiogakure,
    'hunt-td-uzushiogakure',
    { x: 2040, y: 1144 },
    [
      { x: 2536, y: 744 },
      { x: 1928, y: 808 },
    ...
    [MAP_KEYS.huntTdCampoUchiha]: narutoTopdownHunt(
    MAP_KEYS.huntTdCampoUchiha,
    'hunt-td-campo-uchiha',
    { x: 2040, y: 1144 },
    [
      { x: 1432, y: 904 },
      { x: 2360, y: 904 },
    ...
    [MAP_KEYS.huntTdHospitalKonoha]: narutoTopdownHunt(
    MAP_KEYS.huntTdHospitalKonoha,
    'hunt-td-hospital-konoha',
    { x: 2040, y: 1144 },
    [
      { x: 2056, y: 424 },
      { x: 1304, y: 488 },
