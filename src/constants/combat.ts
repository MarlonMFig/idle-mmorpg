...
/**
 * Nameplate compacto: barra fina acima do nome (estilo do vídeo de referência).
 * Antes: 28×4 + nome multi-linha com nível → empilhava e parecia “shatter”.
 */
export const ENEMY_HP_BAR_WIDTH = 36;
export const ENEMY_HP_BAR_HEIGHT = 3;
/** Espaço entre o topo do sprite e o fundo do nome. */
export const NAMEPLATE_GAP_PX = 4;
/** Espaço entre a barra de HP e o topo do nome. */
export const NAMEPLATE_BAR_GAP_PX = 3;
