/**
 * Folha horizontal do idle Shikamaru (fundo azul ~#738cdc) →
 * public/sprites/player/shikamaru/idle.png
 *
 * npm run shikamaru:idle-sheet
 * Fonte: assets/naruto-source/nu/shikamaru-idle-sheet.png
 */
const fs = require('fs');
...
async function main() {
  ...
  // Preview: 1º frame transparente em fundo transparente.
  await sharp(frames[0], { raw: { width: outW, height: outH, channels: 4 } })
    .png()
    .toFile(PREVIEW_PATH);
  ...
  meta['shikamaru-idle'] = {
    ...
    contentHeight,
    source: 'shikamaru-idle-sheet.png',
    frameRate: 7,
  };
