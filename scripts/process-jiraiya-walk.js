/**
 * Jiraiya walk — alpha-only per-frame sequence (6f side walk).
 ...
 *
 * npm run jiraiya:walk
 * Input:  assets/naruto-source/nu/jiraiya/walk/frame_*.png
 * Output: public/sprites/player/jiraiya/walk.png
 */
const fs = require('fs');
...
async function main() {
  ...
  const entry = {
    image: '/sprites/player/jiraiya/walk.png',
    ...
    source: 'assets/naruto-source/nu/jiraiya/walk/frame_001..006.png',
    ...
    note: '6-frame walk; alpha-only; body-lock torso+feet; nearest maxContentH→48; white hair preserved',
  };
  updateMeta(META_JSON, 'jiraiya-walk', entry);
