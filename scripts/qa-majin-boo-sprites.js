/**
 * Strict sprite QA for Majin Boo packed sheets.
...
const OUT = path.join(ROOT, 'public', 'sprites', 'player', 'majin-boo');
...
const SHEETS = [
  { file: 'walk.png', metaKey: 'majin-boo-walk', minOpaque: 80, checkFeet: true },
  { file: 'idle.png', metaKey: 'majin-boo-idle', minOpaque: 100, checkFeet: true },
  { file: 'combo1.png', metaKey: 'majin-boo-combo1', minOpaque: 80, checkFeet: false },
  { file: 'combo2.png', metaKey: 'majin-boo-combo2', minOpaque: 80, checkFeet: false },
  { file: 'combo3.png', metaKey: 'majin-boo-combo3', minOpaque: 80, checkFeet: false },
  { file: 'hurt.png', metaKey: 'majin-boo-hurt', minOpaque: 60, checkFeet: false },
  { file: 'death.png', metaKey: 'majin-boo-death', minOpaque: 40, checkFeet: false },
  { file: 'especial.png', metaKey: 'majin-boo-especial', minOpaque: 40, checkFeet: true, frameCount: 13 },
  { file: 'especial-fx.png', metaKey: 'majin-boo-especial-fx', minOpaque: 20, checkFeet: false },
];
...
async function analyzeStrip(file, fw, fh, n, minOpaque, checkFeet) {
  ...
  if (contentH.length > 1) {
    ...
    if (!/death\.png|especial|hurt\.png|combo\d+\.png/.test(file) && spread > MAX_CONTENT_H_SPREAD) {
...
async function main() {
  ...
  for (const sheet of SHEETS) {
    ...
    const frameCount = sheet.frameCount ?? m.frameCount;
  ...
  console.log('\nQA PASS: Majin Boo sprites clean');
}
