/**
 * Folha horizontal do walk Sasuke (fundo verde #008000) →
 * public/sprites/player/sasuke/walk.png
 *
 * Uso: node scripts/process-sasuke-walk-sheet.js
 * Fonte: assets/naruto-source/nu/sasuke-walk-sheet.png
 */
const fs = require('fs');
...
const INPUT = path.join(ROOT, 'assets', 'naruto-source', 'nu', 'sasuke-walk-sheet.png');
...
async function main() {
  ...
  if (fs.existsSync(metaPath)) {
    ...
    try {
      meta = JSON.parse(raw.slice(0, last + 1));
    } catch {
      meta = {};
    }
  }
