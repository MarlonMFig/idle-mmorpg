/**
 * Kakashi idle — alpha-only per-frame sequence (6f breath).
 ...
 *
 * npm run kakashi:idle
 * Input:  assets/naruto-source/nu/kakashi/idle/frame_*.png
 * Output: public/sprites/player/kakashi/idle.png + preview
 */
const fs = require('fs');
...
const INPUT_DIR = path.join(ROOT, 'assets', 'naruto-source', 'nu', 'kakashi', 'idle');
...
async function main() {
  ...
  const entry = {
    image: '/sprites/player/kakashi/idle.png',
    ...
    source: 'assets/naruto-source/nu/kakashi/idle/frame_001..006.png',
    ...
    note: '6-frame idle; alpha-only; body-lock torso+feet; nearest scale matched walk; silver hair preserved',
  };
  updateMeta(META_JSON, 'kakashi-idle', entry);
