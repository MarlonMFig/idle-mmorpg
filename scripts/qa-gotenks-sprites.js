/**
 * Strict sprite QA for Gotenks packed sheets.
...
const OUT = path.join(ROOT, 'public', 'sprites', 'player', 'gotenks');
...
const SHEETS = [
  { file: 'walk.png', metaKey: 'gotenks-walk', minOpaque: 80, checkFeet: true },
  { file: 'idle.png', metaKey: 'gotenks-idle', minOpaque: 100, checkFeet: true },
  { file: 'combo1.png', metaKey: 'gotenks-combo1', minOpaque: 80, checkFeet: false },
  { file: 'combo2.png', metaKey: 'gotenks-combo2', minOpaque: 80, checkFeet: false },
  { file: 'combo3.png', metaKey: 'gotenks-combo3', minOpaque: 80, checkFeet: false },
  { file: 'hurt.png', metaKey: 'gotenks-hurt', minOpaque: 60, checkFeet: false },
  { file: 'death.png', metaKey: 'gotenks-death', minOpaque: 40, checkFeet: false },
  { file: 'especial.png', metaKey: 'gotenks-especial', minOpaque: 40, checkFeet: true, frameCount: 16 },
  { file: 'ghost-fx.png', metaKey: 'gotenks-ghost-fx', minOpaque: 20, checkFeet: false },
];
...
async function analyzeStrip(file, fw, fh, n, minOpaque, checkFeet) {
  ...
  if (checkFeet && feetX.length > 1) {
    ...
    if (contentH.length > 1) {
      ...
      if (!/death\.png|especial|hurt\.png|ghost-fx/.test(file) && spread > MAX_CONTENT_H_SPREAD) {
